<?php
  ...
  function is_blank($value) {
    // returns true if value is not set or "space" is entered as value.
  ...
  function has_presence($value) {
    // if is_blank is true, has_presence = false
  ...
  // * uses !== to prevent position 0 from being considered false [0 is not false]
  // * strpos is faster than preg_match() (preg: perl regular expression)
