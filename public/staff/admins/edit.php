...
<div id="content">
  ...
  <div class="admin edit">
    ...
    <form action="<?php echo url_for('/staff/admins/edit.php?id=' . hsc(u($id))); ?>" method="post">
      <dl>
        <dt>First Name</dt>
        <dd><input type="text" name="first_name" value="<?php echo hsc($admin['first_name']);?>" /></dd>
      </dl>
      <dl>
        <dt>Last Name</dt>
        <dd><input type="text" name="last_name" value="<?php echo hsc($admin['last_name']);?>" /></dd>
      </dl>
      <dl>
        <dt>Email</dt>
        <dd><input type="text" name="email" value="<?php echo hsc($admin['email']);?>" /></dd>
      </dl>
      <dl>
        <dt>Username</dt>
        <dd><input type="text" name="username" value="<?php echo hsc($admin['username']);?>" /></dd>
      </dl>
      <dl>
        <dt>Password</dt>
