...
if(is_post_request()) {
  ...
  redirect_to(url_for('/staff/subjects/show.php?id=' . hsc(u($page['subject_id']))));
}
...
<div id="content">
  ...
  <div class="page delete">
    ...
    <p class="item"><?php echo hsc($page['menu_name']); ?></p>

    <form action="<?php echo url_for('/staff/pages/delete.php?id=' . hsc(u($page['id']))); ?>" method="post">
      <div id="operations">
